...
const App = {
  setup() {
    ...
    const createProject = async () => {
      ...
      body.innerHTML = `<form><label for="projectName">Name:</label><input type="text" id="projectNameInput" class="form-control" required>

      <label for="projectDescription">Description:</label><input type="text" id="projectDescriptionInput" class="form-control" required>
      ...
      modal
        ...
        .addEventListener("click", async (e) => {
          ...
          //   Status.innerHTML = `
          //     <span class="status"><i class='fa fa-solid fa-circle faa-burst animated fa text-success'></i></span>
    ...
    const changeStatus = async (id) => {
      const formCheck = document.querySelector(`.formCheck`);
      const status = formCheck.checked ? "close" : "open";
      const baseUrl = `https://srm-vbc7.onrender.com/api/projects/${id}`;
      const token =
        "";
      const headers = {
